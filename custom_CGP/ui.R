  ...
  dashboardSidebar(
    sidebarMenu(
      ...
      menuItem("Performance", tabName = "performance", icon = icon("chart-line"),
               menuSubItem("Feasibility", tabName = "feasibility", icon = icon("balance-scale")),
               menuSubItem("Patient journey", tabName = "patient_journey", icon = icon("project-diagram")),
               menuSubItem("Diagnostic results", tabName = "diagnostic_results", icon = icon("sitemap")),
               menuSubItem("Organization of laboratories", tabName = "org_lab", icon = icon("microscope")),
               menuSubItem("Scientific spillover", tabName = "sci_spill", icon = icon("globe")),
               menuSubItem("Scores", tabName = "performance", icon = icon("balance-scale"))
               ),
    ...
    tabItems(
      ...
      tabItem(
        ...
        fluidRow(
          box(
            width = 12,
            title = "Feasibility Determinant", 
            status = "primary", 
            solidHeader = TRUE,
            p("Select stakeholder groups and workplace settings to analyze feasibility determinants:")
          )
        ),
        fluidRow(
          box(
            ...
            checkboxGroupInput(
              "feas_stakeholders",
              "Stakeholder Groups:",
              choices = c("Pulmonologist" = "Pulmonologist",
                          "CMBP" = "CMBP",
                          "Pathologist" = "Pathologist",
                          "Patient representative" = "Patient representative"),
              selected = c("Pulmonologist", "CMBP", "Pathologist", "Patient representative")
            ),
            checkboxGroupInput(
              "feas_settings",
              "Workplace Settings:",
              choices = c("Academic Center" = "Academic Center",
                          "General Center" = "General Center",
                          "Neither (Patient representative)" = "Neither (Patient representative)"),
              selected = c("Academic Center", "General Center", "Neither (Patient representative)")
            ),
            actionButton("update_feas", "Update View", icon = icon("refresh"))
          ),
          box(
            width = 9,
            title = "Feasibility Responses",
            status = "primary",
            solidHeader = TRUE,
            plotOutput("feasibility_plot", height = "500px")
          )
        ),
        fluidRow(
          box(
            width = 12,
            title = "Performance Comparison - Total",
            status = "primary",
            solidHeader = TRUE,
            fluidRow(
              column(6, plotOutput("feas_total_plot", height = "300px")),
              column(6, DTOutput("feas_total_table"))
            )
          )
        ),
        fluidRow(
          box(
            width = 12,
            title = "Performance Comparison - By Stakeholder Type",
            status = "primary",
            solidHeader = TRUE,
            fluidRow(
              column(12, plotOutput("feas_stakeholder_plot", height = "300px"))
            ),
            fluidRow(
              column(12, DTOutput("feas_stakeholder_table"))
            )
          )
        ),
        fluidRow(
          box(
            width = 12,
            title = "Performance Comparison - By Workplace Setting",
            status = "primary",
            solidHeader = TRUE,
            fluidRow(
              column(12, plotOutput("feas_setting_plot", height = "300px"))
            ),
            fluidRow(
              column(12, DTOutput("feas_setting_table"))
            )
          )
        )
      ),
      ...
      ##########  Patient Journey Tab #####
      tabItem(
        tabName = "patient_journey",
        fluidRow(
          box(
            width = 12,
            title = "Patient Journey Determinants", 
            status = "primary", 
            solidHeader = TRUE,
            p("Select stakeholder groups and workplace settings to analyze patient journey determinants:")
          )
        ),
        fluidRow(
          box(
            ...
            actionButton("update_journey", "Update View", icon = icon("refresh"))
          ),
          box(
            width = 9,
            title = "Patient Journey Responses",
            status = "primary",
            solidHeader = TRUE,
            plotOutput("journey_plot", height = "500px")
          )
        ),
        fluidRow(
          box(
            ...
            solidHeader = TRUE,
            fluidRow(
              column(6, plotOutput("journey_total_plot", height = "300px")),
              column(6, DTOutput("journey_total_table"))
            )
          )
        ),
        fluidRow(
          box(
            ...
            solidHeader = TRUE,
            fluidRow(
              column(12, plotOutput("journey_stakeholder_plot", height = "300px"))
            ),
            fluidRow(
              column(12, DTOutput("journey_stakeholder_table"))
            )
          )
        ),
        fluidRow(
          box(
            ...
            solidHeader = TRUE,
            fluidRow(
              column(12, plotOutput("journey_setting_plot", height = "300px"))
            ),
            fluidRow(
              column(12, DTOutput("journey_setting_table"))
            )
          )
        )
      ),
      ...
      tabItem(
        tabName = "diagnostic_results",
        fluidRow(
          box(
            width = 12,
            title = "Diagnostic Results Determinants", 
            status = "primary", 
            solidHeader = TRUE,
            p("Select stakeholder groups and workplace settings to analyze diagnostic results determinants:")
          )
        ),
        fluidRow(
          box(
            ...
            actionButton("update_diagnostic", "Update View", icon = icon("refresh"))
          ),
          box(
            width = 9,
            title = "Diagnostic Results Responses",
            status = "primary",
            solidHeader = TRUE,
        ...
        fluidRow(
          box(
            ...
            solidHeader = TRUE,
            fluidRow(
              column(6, plotOutput("diagnostic_total_plot", height = "300px")),
              column(6, DTOutput("diagnostic_total_table"))
            )
          )
        ),
        fluidRow(
          box(
            ...
            solidHeader = TRUE,
            fluidRow(
              column(12, plotOutput("diagnostic_stakeholder_plot", height = "300px"))
            ),
            fluidRow(
              column(12, DTOutput("diagnostic_stakeholder_table"))
            )
          )
        ),
        fluidRow(
          box(
            ...
            solidHeader = TRUE,
            fluidRow(
              column(12, plotOutput("diagnostic_setting_plot", height = "300px"))
            ),
            fluidRow(
              column(12, DTOutput("diagnostic_setting_table"))
            )
          )
        )
      ),
      ...
      tabItem(
        ...
        fluidRow(
          box(
            width = 12,
            title = "Laboratory Organization Determinants", 
            status = "primary", 
            solidHeader = TRUE,
            p("Select stakeholder groups and workplace settings to analyze laboratory organization determinants:")
          )
        ),
        fluidRow(
          box(
            ...
            actionButton("update_orglab", "Update View", icon = icon("refresh"))
          ),
          box(
            width = 9,
            title = "Laboratory Organization Responses",
            status = "primary",
            solidHeader = TRUE,
            plotOutput("orglab_plot", height = "500px")
          )
        ),
        fluidRow(
          box(
            ...
            solidHeader = TRUE,
            fluidRow(
              column(6, plotOutput("orglab_total_plot", height = "300px")),
              column(6, DTOutput("orglab_total_table"))
            )
          )
        ),
        fluidRow(
          box(
            ...
            solidHeader = TRUE,
            fluidRow(
              column(12, plotOutput("orglab_stakeholder_plot", height = "300px"))
            ),
            fluidRow(
              column(12, DTOutput("orglab_stakeholder_table"))
            )
          )
        ),
        fluidRow(
          box(
            ...
            solidHeader = TRUE,
            fluidRow(
              column(12, plotOutput("orglab_setting_plot", height = "300px"))
            ),
            fluidRow(
              column(12, DTOutput("orglab_setting_table"))
            )
          )
        )
      ),
      ...
      tabItem(
        ...
        fluidRow(
          box(
            width = 12,
            title = "Scientific Spillover Determinants", 
            status = "primary", 
            solidHeader = TRUE,
            p("Select stakeholder groups and workplace settings to analyze scientific spillover determinants:")
          )
        ),
        fluidRow(
          box(
            ...
            actionButton("update_scispill", "Update View", icon = icon("refresh"))
          ),
          box(
            width = 9,
            title = "Scientific Spillover Responses",
            status = "primary",
            solidHeader = TRUE,
            plotOutput("scispill_plot", height = "500px")
          )
        ),
        fluidRow(
          box(
            ...
            solidHeader = TRUE,
            fluidRow(
              column(6, plotOutput("scispill_total_plot", height = "300px")),
              column(6, DTOutput("scispill_total_table"))
            )
          )
        ),
        fluidRow(
          box(
            ...
            solidHeader = TRUE,
            fluidRow(
              column(12, plotOutput("scispill_stakeholder_plot", height = "300px"))
            ),
            fluidRow(
              column(12, DTOutput("scispill_stakeholder_table"))
            )
          )
        ),
        fluidRow(
          box(
            ...
            solidHeader = TRUE,
            fluidRow(
              column(12, plotOutput("scispill_setting_plot", height = "300px"))
            ),
            fluidRow(
              column(12, DTOutput("scispill_setting_table"))
            )
          )
        )
      ),
      ...
      tabItem(
        ...
        # Performance scoring and aggregation
        fluidRow(
          box(
            width = 6,
            ...
            solidHeader = TRUE,
            checkboxInput(
              "include_clinical_survey",
              "Include Clinical Benefit", 
              value = TRUE
            ),
            numericInput(
              "clinical_tp_survey",
              "Clinical (Targeted Profiling)",
              value = 50, min = 0, max = 100, step = 1
            ),
            numericInput(
              "clinical_cgp_survey",
              "Clinical (Comprehensive Genomic Profiling)",
              value = 50, min = 0, max = 100, step = 1
            ),
            checkboxInput(
              "include_costeff_survey",
              "Include Cost‑Effectiveness", 
              value = TRUE
            ),
            numericInput(
              "cost_tp_survey",
              "Cost‑Eff (Targeted Profiling)",
              value = 50, min = 0, max = 100, step = 1
            ),
            numericInput(
              "cost_cgp_survey",
              "Cost‑Eff (Comprehensive Genomic Profiling)",
              value = 50, min = 0, max = 100, step = 1
            ),
            actionButton(
              "update_aggregate_survey", 
              "Recompute Aggregate", 
        ...
        fluidRow(
          box(
            width = 12,
            title = "Aggregated Scores Visualization",
            status = "primary",
            solidHeader = TRUE,
            plotOutput("aggregate_plot", height = "400px")
          )
        ),
